...
- Axum API with REST endpoints and an SSE event stream for direct task changes, scheduler-driven task changes, worker attempt events, main-agent replies, main-agent actions, scheduler ticks, scheduler loop errors, and heartbeats.
