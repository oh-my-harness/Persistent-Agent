...
- Main-agent conversation commands in Chinese and English for create, list, explain state, pause, resume, cancel, reprioritize, reorder, dependency changes, and summarize.
