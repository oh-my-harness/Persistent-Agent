...
- Main-agent conversation commands in Chinese and English for create, list, explain state, request clarification, pause, resume, cancel, reprioritize, reorder, dependency changes, and summarize.
