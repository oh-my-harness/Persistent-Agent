...
- main conversation: talk to the main agent to create, update, reorder, explain, inspect workspace state, list workspace directories, preview workspace files, show audit actions, or discuss tasks;
